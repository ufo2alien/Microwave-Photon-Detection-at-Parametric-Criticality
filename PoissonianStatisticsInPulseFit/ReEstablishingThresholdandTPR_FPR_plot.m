...
% clf;
% subplot(2,2,3)
semilogx(db2pow(probePower(1,1:probePowerI)-101.3-30)*Energy./(h_p.*PumpGenFreqCent/2), [ ClickProbMeanTrue(1,1:probePowerI).'  ClickProbMeanFalse(1,1:probePowerI).' (ClickProbMeanTrue(1,1:probePowerI).'-ClickProbMeanFalse(1,1:probePowerI).')./(1-ClickProbMeanFalse(1,1:probePowerI).')],'Linewidth',3);
